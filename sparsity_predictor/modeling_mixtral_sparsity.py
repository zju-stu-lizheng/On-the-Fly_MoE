...
up_th = None
def load_thresholds(threshold_path, use_average=False, zero = False, use_type="gate"):
    """
    ...
    if use_average:
        up_th = torch.load(threshold_path, map_location='cuda')[f"{use_type}_proj_states_thresholds_2"]
    else:
