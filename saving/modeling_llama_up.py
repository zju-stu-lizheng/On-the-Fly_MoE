...
def set_th_sparsity(sparsity, dataset='c4-llama'):
    """
    根据稀疏程度读取对应的阈值
    """
    global th
    filename=f"../../moe-offloading/notebooks/threshold/llama3_new/th_{sparsity}.csv"
...
class LlamaMLP(nn.Module):
    def __init__(self, config, layer_idx: int, expert_idx: int):
        super().__init__()
        self.config = config
