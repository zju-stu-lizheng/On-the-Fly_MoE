...
class PhimoeBlockSparseTop2MLP(nn.Module):
    def __init__(self, config: PhimoeConfig, layer_idx=0, expert_idx=0):
        super().__init__()
        self.layer_idx = layer_idx
    ...
    def print_ratio(self):
        ...
        if self.token_sum == 0:
            ...
            return
        print(f'layer {self.layer_idx} expert {self.expert_idx} ratio: {self.count_sum/self.token_sum:.4f}')
        self.count_sum = 0
        self.token_sum = 0
...
class PhimoeSparseMoeBlock(nn.Module):
    ...
    def __init__(self, config, layer_idx):
        ...
        self.experts = nn.ModuleList([PhimoeBlockSparseTop2MLP(config,layer_idx,i) for i in range(self.num_experts)])
...
class PhimoeDecoderLayer(nn.Module):
    def __init__(self, config: PhimoeConfig, layer_idx: int):
        ...
        self.block_sparse_moe = PhimoeSparseMoeBlock(config, layer_idx=layer_idx)
