...
class MixtralSparseMoeBlock(nn.Module):
    ...
    def forward(self, hidden_states: torch.Tensor) -> torch.Tensor:
        ...
        for i in range(batch_size * sequence_length):
            ...
            current_state = flat_hidden_states[i]
            ...
            for expert_idx, weight in zip(current_experts, current_weights):
                expert_layer = self.experts[expert_idx]
                expert_output += expert_layer(hidden_states = current_state.unsqueeze(0)).squeeze(0) * weight
...
class MixtralModel(MixtralPreTrainedModel):
    ...
    def __init__(self, config: MixtralConfig):
        ...
        print('using atten...', config._attn_implementation)
